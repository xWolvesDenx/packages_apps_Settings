...
public class AppOpsState {
    ...
    public AppOpsState(Context context) {
        ...
        mOpSummaries = context.getResources().getTextArray(R.array.app_ops_labels_validus);
        mOpLabels = context.getResources().getTextArray(R.array.app_ops_labels_validus);
    }
